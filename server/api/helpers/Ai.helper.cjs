...
exports.analyzeGrowth = async (analytics) => {
...
exports.analyzeBreakdown = async (analytics) => {
...
exports.analyzeSeasonality = async (analytics) => {
...
exports.analyzeRisks = async (allAnalytics) => {
  const insights = [];
 ...
 * اكتشاف الفرص
 */
exports.discoverOpportunities = async (allAnalytics) => {
  const insights = [];
